...
public class SLinkedList<E extends DeepClone<E>> implements Iterable<E> {
	...
	/**
	 * Show all elements in list. Alternatively I could have overriden the
	 * toString() method and then just print the object, since printing an object
	 * automatially calls the toString() method.
	 */
	public void show() {
		SNode<E> cur = head;
		while (cur != null) {
	...
	public SLinkedList<E> deepClone() {
		...
		while (curr != null) {
			...
			list.addLast(curr.element.deepClone());
			curr = curr.next;
	...
	// The next two methods are private. The client has no access to the nodes of
	// the linked list,
